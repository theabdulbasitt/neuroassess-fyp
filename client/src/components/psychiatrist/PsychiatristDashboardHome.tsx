...
export default function PsychiatristDashboardHome() {
  const { user } = useAuth();
  ...
  const cards = [
    ...
    },
    {
      icon: ClipboardList,
      title: "Assessments",
      description: "Review patient assessments",
      color: "bg-amber-500",
    ...
    },
    {
      icon: FileText,
      title: "Reports",
      description: "Generate and view patient reports",
      color: "bg-rose-500",
  ...
  const handleCardClick = (id: string) => {
    ...
    navigate(`/psychiatrist/dashboard?tab=${id}`, { replace: true });
  };
  ...
  return (
    <div>
      ...
      <motion.div
        ...
        className="mt-8 bg-gradient-to-r from-indigo-500 to-purple-600 p-6 rounded-xl shadow-lg text-white"
      >
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <button
            className="mt-4 md:mt-0 px-6 py-3 bg-white text-indigo-600 rounded-xl font-medium hover:bg-indigo-50 transition-colors"
